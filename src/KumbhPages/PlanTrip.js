...
const places = [
  ...
  { id: 51, name: "Mahatma Market", category: "shopping", budget: "economy", address: "Nashik, Maharashtra" },
{ id: 52, name: "City Centre Mall", category: "shopping", budget: "normal", address: "Untwadi Road, Nashik, Maharashtra 422009" },
{ id: 53, name: "Ganga Ghat Market", category: "shopping", budget: "economy", address: "Godavari Riverfront, Nashik, Maharashtra" },
{ id: 54, name: "Saraf Bazar", category: "shopping", budget: "economy", address: "Main Road, Nashik, Maharashtra" },
{ id: 55, name: "Kalanagar Market", category: "shopping", budget: "economy", address: "Kalanagar, Nashik, Maharashtra" },
{ id: 56, name: "Tapovan Market", category: "shopping", budget: "economy", address: "Tapovan, Nashik, Maharashtra" },
{ id: 57, name: "Dindori Street Market", category: "shopping", budget: "economy", address: "Dindori Road, Nashik, Maharashtra" },
{ id: 58, name: "Nashik Galleria Mall", category: "shopping", budget: "normal", address: "College Road, Nashik, Maharashtra" },
{ id: 59, name: "Old Agra Road Market", category: "shopping", budget: "economy", address: "Old Agra Road, Nashik, Maharashtra" },
{ id: 60, name: "Ambad Industrial Market", category: "shopping", budget: "economy", address: "Ambad MIDC, Nashik, Maharashtra" },
{ id: 61, name: "Anjaneri Hills", category: "adventure", budget: "economy", address: "Anjaneri, Nashik, Maharashtra" },
{ id: 62, name: "Dugarwadi Waterfalls", category: "adventure", budget: "economy", address: "Dugarwadi, Nashik, Maharashtra" },
{ id: 63, name: "Pandav Caves Trek", category: "adventure", budget: "normal", address: "Pandav Leni, Nashik, Maharashtra" },
{ id: 64, name: "Sandhan Valley Trek", category: "adventure", budget: "luxury", address: "Sandhan Valley, Nashik, Maharashtra" },
{ id: 65, name: "Saptashrungi Trek", category: "adventure", budget: "economy", address: "Vani, Nashik, Maharashtra" },
{ id: 66, name: "Igatpuri Camping", category: "adventure", budget: "luxury", address: "Igatpuri, Nashik, Maharashtra" },
{ id: 67, name: "Tringalwadi Fort", category: "adventure", budget: "economy", address: "Tringalwadi, Nashik, Maharashtra" },
{ id: 68, name: "Harihar Fort Trek", category: "adventure", budget: "economy", address: "Nirgudpada, Nashik, Maharashtra" },
{ id: 69, name: "Vaitarna Dam Adventures", category: "adventure", budget: "normal", address: "Vaitarna, Nashik, Maharashtra" },
{ id: 70, name: "Darna Dam Kayaking", category: "adventure", budget: "normal", address: "Darna Dam, Nashik, Maharashtra" },
{ id: 71, name: "Someshwar Waterfalls", category: "nature", budget: "economy", address: "Someshwar, Nashik, Maharashtra" },
{ id: 72, name: "Godavari Riverfront", category: "nature", budget: "economy", address: "Panchavati, Nashik, Maharashtra" },
{ id: 73, name: "Kusumagraj Smarak Garden", category: "nature", budget: "normal", address: "Nashik City, Maharashtra" },
{ id: 74, name: "Dugarwadi Waterfalls", category: "nature", budget: "economy", address: "Dugarwadi, Nashik, Maharashtra" },
{ id: 75, name: "Talegaon Lake", category: "nature", budget: "economy", address: "Talegaon, Nashik, Maharashtra" },
{ id: 76, name: "Nilgiri Baug", category: "nature", budget: "normal", address: "Nashik Road, Maharashtra" },
{ id: 77, name: "Satpur Green Belt", category: "nature", budget: "economy", address: "Satpur, Nashik, Maharashtra" },
{ id: 78, name: "Igatpuri Hill View", category: "nature", budget: "luxury", address: "Igatpuri, Nashik, Maharashtra" },
{ id: 79, name: "Chambhar Leni Garden", category: "nature", budget: "economy", address: "Nashik, Maharashtra" },
{ id: 80, name: "Ganeshwadi Eco Park", category: "nature", budget: "normal", address: "Ganeshwadi, Nashik, Maharashtra" },
{ id: 81, name: "Pandav Leni Caves", category: "artCulture", budget: "normal", address: "Pandav Leni, Nashik, Maharashtra" },
{ id: 82, name: "Artillery Museum", category: "artCulture", budget: "normal", address: "Deolali, Nashik, Maharashtra" },
{ id: 83, name: "Bhakti Dham Temple", category: "artCulture", budget: "economy", address: "Panchavati, Nashik, Maharashtra" },
{ id: 84, name: "Shree Kapaleshwar Mandir", category: "artCulture", budget: "economy", address: "Panchavati, Nashik, Maharashtra" },
{ id: 85, name: "Kala Kruti Art Gallery", category: "artCulture", budget: "normal", address: "Nashik City, Maharashtra" },
{ id: 86, name: "Veda Mandir", category: "artCulture", budget: "economy", address: "Nashik Road, Maharashtra" },
{ id: 87, name: "Museum of Numismatics", category: "artCulture", budget: "normal", address: "Gandhinagar, Nashik, Maharashtra" },
{ id: 88, name: "Kalaram Mandir", category: "artCulture", budget: "economy", address: "Panchavati, Nashik, Maharashtra" },
{ id: 89, name: "Coin Museum", category: "artCulture", budget: "normal", address: "Anjneri, Nashik, Maharashtra" },
{ id: 90, name: "Shree Swaminarayan Mandir", category: "artCulture", budget: "normal", address: "Dindori Road, Nashik, Maharashtra" },
{ id: 91, name: "Chandwad Fort", category: "historical", budget: "economy", address: "Chandwad, Nashik, Maharashtra" },
{ id: 92, name: "Igatpuri Fort", category: "historical", budget: "economy", address: "Igatpuri, Nashik, Maharashtra" },
{ id: 93, name: "Ahivant Fort", category: "historical", budget: "economy", address: "Ahivantwadi, Nashik, Maharashtra" },
{ id: 94, name: "Bhaskargad Fort (Basgad)", category: "historical", budget: "economy", address: "Igatpuri, Nashik, Maharashtra" },
{ id: 95, name: "Ankai-Tankai Forts", category: "historical", budget: "economy", address: "Ankai, Nashik, Maharashtra" },
{ id: 96, name: "Shivaji Fort", category: "historical", budget: "economy", address: "Nashik City, Maharashtra" },
{ id: 97, name: "Dhodap Fort", category: "historical", budget: "economy", address: "Kalwan, Nashik, Maharashtra" },
{ id: 98, name: "Harihar Fort", category: "historical", budget: "economy", address: "Trimbak, Nashik, Maharashtra" },
{ id: 99, name: "Sinnar Fort", category: "historical", budget: "economy", address: "Sinnar, Nashik, Maharashtra" },
{ id: 100, name: "Kavnai Fort", category: "historical", budget: "economy", address: "Kavnai, Nashik, Maharashtra" }
